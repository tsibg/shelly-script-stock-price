...
Shelly script to monitor Stock prices as virtual components. 

It turns your Shelly Gen3 device into a stock price monitor by creating virtual components to display the current price of a stock symbol (e.g., "SLYG.DE") to the device WebUI. Allows you to display the stock prices directly in the Shelly App dashboards as virtual device. 
